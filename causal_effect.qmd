...
execute: 
  echo: false
---
We have a table of citizens in Michigan and we want to find if a postcard would change the civic engagement of the citizens in 2026. One problem with the data is that it's from Michigan, which wouldn't accurately portray Texas citizens. The neighbors treatment seems to be the most effective. We found that with the neighbors treatment, the likelihood of voting will be an increase of  3.1 to 5.6 percent in 95% of cases.
```{r}
#| label: setup
#| message: false 
